...
test_dataframe = pd.DataFrame({'float64': [1.0, 3.0, 4, -5, 6],
                    ...
                    'int64': [1, 2, 3, -5, 6],
                    'int64_null': [1, 2, np.nan, np.inf, None],
                    'int64_null_const': [1, 1, np.nan, np.inf, None],
                    'int64_const': [1, 1, 1, 1, 1],
                    'long_const': [65536*65536, 65536*65536, 65536*65536, 65536*65536, 65536*65536],
                    'long_null_const': [65536*65536, 65536*65536, np.nan, np.inf, None],
                    ...
                    'object_const_null': ['foo','foo', None, None, None],
